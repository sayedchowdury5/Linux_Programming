...
int main()
{
	...
	/* determine the middle position of the file */
	middle = total/2;

	/* move the file pointer */
	position = lseek(in, middle, SEEK_SET);
